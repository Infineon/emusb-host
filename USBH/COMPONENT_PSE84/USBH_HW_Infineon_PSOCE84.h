...
----------------------------------------------------------------------
Purpose     : USB host driver for PSOCE84
-------------------------- END-OF-HEADER -----------------------------
*/

#ifndef USBH_HW_INFINEON_PSOCE84_H_
#define USBH_HW_INFINEON_PSOCE84_H_
...
void USBH_Infineon_PSOCE84_SetPLLRefClock(unsigned MHz);
void USBH_Infineon_PSOCE84_DMA_SetPLLRefClock(unsigned MHz);

#if defined(__cplusplus)
  }
#endif

#endif // USBH_HW_INFINEON_PSOCE84_H_
